...
class TwitterServiceTwitterfeed2(models.Model):
    ...
    x = models.CharField(db_column='X', max_length=255) # Field name made lowercase.
    ...
    sentiment = models.CharField(blank=True,null=True,max_length=255)
    ...
    def get_tweets(self):
        tweets = TwitterServiceTwitterfeed2.objects.all()
        return tweets
